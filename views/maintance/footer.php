		<footer class="mt-4 pt-4 pb-4 bg-dark" align="center">
			<span style="color:white;">All Rights Reserved © 2019 Math Worm</span>
		</footer>
	...
	<script type="text/javascript" src="<?= __URLS__ ?>assets/js/SlimWhizzy.min.js"></script>
</html>